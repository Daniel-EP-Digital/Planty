...
<?php
// Récupérer le modèle Elementor
$model_id = 24; // ID du modèle Elementor
$model = Elementor\Plugin::instance()->frontend->get_builder_content( $model_id );

// Afficher le modèle Elementor
echo $model;
?>

	<div class="footer-inner">
		
<?php /*	ANCIEN CODE ELEMENTOR
 ...
 */?>
		<?php if ( $footer_nav_menu ) : ?>
			<nav class="site-navigation-footer <?php echo esc_attr( hello_show_or_hide( 'hello_footer_menu_display' ) ); ?>" role="navigation">
				<?php
